        ...
        <div className="grid grid-cols-1 gap-6 sm:gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              ...
              <Link href="/editorial-policy" className="text-muted transition hover:text-gold">Content Policy</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-2 text-sm">
              <Link href="/" className="text-muted transition hover:text-gold">Daily Fortune</Link>
