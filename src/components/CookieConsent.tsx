...
export default function CookieConsent() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-4">
      <div className="mx-auto max-w-4xl rounded-xl border border-border bg-background/95 px-6 py-4 shadow-[0_0_30px_rgba(212,160,74,0.15)] backdrop-blur-md">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex shrink-0 gap-3">
            <button
              ...
              className="rounded-lg border border-border px-4 py-2.5 text-sm text-foreground/60 transition hover:border-gold/40 hover:text-foreground/80"
            >
              Reject
            </button>
            <button
